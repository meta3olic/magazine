...
class CartController
{
    ...
    public function actionAdd($id)
    {
        ...
        echo `<script language="javascript">location.replace("{$referrer}")</script>`;
    ...
    public function actionDelete($id)
    {
        ...
        echo '<script language="javascript">location.replace("/cart")</script>';
    ...
    public function actionCheckout()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($errors == false) {
                ...
                $result = Order::save($userName, $userPhone, $userComment, $userId, $data, $productsInCart);
                // $result = Order::save($userName, $userPhone, $userComment, $userId);

                // $productsIds = serialize($productsIds);


                if ($result) {
                    // Если заказ успешно сохранен
                    // Оповещаем администратора о новом заказе по почте                
                    $adminEmail = 'aldashkov@icloud.com';
