...
class Order
{
    ...
    public static function save($userName, $userPhone, $userComment, $userId, $date, $products)
    {
        ...
        // Текст запроса к БД
        $sql = 'INSERT INTO product_order (user_name, user_phone, user_comment, user_id, date, products) '
    ...
    public static function getOrdersList()
    {
        ...
        // $ordersList->bindParam(':id', $id, PDO::PARAM_INT);
        // $ordersList->bindParam(':user_name', $user, PDO::PARAM_STR);
        // $ordersList->bindParam(':user_phone', $user_phone, PDO::PARAM_INT);
        // $ordersList->bindParam(':date', $date, PDO::PARAM_INT);
        // $ordersList->bindParam(':status', $status, PDO::PARAM_INT);
        // $ordersList->bindParam(':id', $id, PDO::PARAM_INT);
        //     var_dump($ordersList->execute());
        // return $ordersList->execute();
